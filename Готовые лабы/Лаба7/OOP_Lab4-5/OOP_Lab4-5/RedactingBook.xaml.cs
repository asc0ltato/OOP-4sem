...
namespace OOP_Lab4_5
{
    public partial class RedactingBook : Window
    {
        ...
        public RedactingBook(Book book, Library currentBooksList, Stack<Library> undoStack, Stack<Library> redoStack)
        {
            ...
            Cursor = customCursor;
            in_stock.textBoxUC1.Text = _book.InStock.ToString();
            rating.textBoxUC.Text = _book.Rating;
            FillFields();
        }
        ...
        private void addBookButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(bookName.Text) || string.IsNullOrEmpty(bookAuthor.Text) ||
                    string.IsNullOrEmpty(genre.Text) || string.IsNullOrEmpty(in_stock.textBoxUC1.Text) ||
                    string.IsNullOrEmpty(rating.textBoxUC.Text))
                {
                ...
                _book.InStock = int.Parse(in_stock.textBoxUC1.Text);
                _book.Rating = rating.textBoxUC.Text;
                ...
                MessageBox.Show($"Название: {bookName.Text}\n" +
                    ...
                    $"\nВ наличии: {in_stock.textBoxUC1.Text}\nРейтинг: " +
