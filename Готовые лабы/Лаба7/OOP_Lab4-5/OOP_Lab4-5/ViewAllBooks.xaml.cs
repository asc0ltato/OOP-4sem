...
namespace OOP_Lab4_5
{
    public partial class ViewAllBooks : Window
    {
        ...
        public static RoutedUICommand BackCommand { get; } = new RoutedUICommand("Back", "Back", typeof(ViewAllBooks));
        ...
        public ViewAllBooks()
        {
            ...
            Cursor = customCursor;
            CommandBindings.Add(new CommandBinding(BackCommand, BackCommand_Executed));
        }
        ...
        private void CommandBinding_Executed_3(object sender, RoutedEventArgs e)
        {
            ...
            if (bookEdit != null)
            {
                ...
                if (edit.ShowDialog() == true)
                {
                    ...
                    bookEdit.InStock = int.Parse(edit.in_stock.textBoxUC1.Text);
                    bookEdit.Rating = edit.rating.textBoxUC.Text;
